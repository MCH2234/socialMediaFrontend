...
import MainPost from "../../post/postsubs/mainpost";
import AddComment from "../../comments/addcomment";
import Comments from "../../comments/comments";
import { useOutletContext } from "react-router";
import { useState } from "react";
const UserPost = ({ post, isUserPost, removePost }) => {
  const { JWT, user, fetchURL } = useOutletContext();
  ...
  let initials = user.first[0].toUpperCase() + user.last[0].toUpperCase();
